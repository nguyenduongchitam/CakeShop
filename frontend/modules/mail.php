...
<body>
    <div class="mail">
    <div class="content">
    <img src="../modules/images/Header-logo.png" class="img-fluid-logo" alt="Logo">
    ...
    <button class="button"><a href="index.php?action=homepage&query=none" style="text-decoration: none;" >Website <b style="color: #DA0C81; letter-spacing: 3px;"> IULÀĐÂY</b></button>
</body>
</html>