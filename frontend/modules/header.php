              ...
              <div class="row">
               ...
               <li><a class="dropdown-item" href="logout.php">Đăng xuất</a></li>
                     ...
                     <li><a class="dropdown-item" href="sign-in.php">Đăng Nhập</a></li>
                        ...
                        <li class="nav-item">
                          <a class="nav-link active" aria-current="page" href="cart.php" style="padding-top: 0; color:#4d2600;"><i class="bi bi-basket2 account bigger-icon"></i> <?php if (isset($_SESSION['quantity_in_cart'])) echo $_SESSION['quantity_in_cart'];
                                                                                                                                                                                  else echo 0; ?></a>
                        </li>
                      </ul>
                    </div>
...
<!--  <section class="myheader" style="background-color: #C7DCA7;">
    <div class=" container-fluid fs-4 text-center headerig" style="padding: 0;">
      <div class="row align-items-center">
        ...
        ?>
        <a href="cart.php" class="col-md-1 account small-icon"><i class="bi bi-basket2"></i><?php if (isset($_SESSION['quantity_in_cart'])) echo $_SESSION['quantity_in_cart'];
                                                                                            else echo 0; ?></a>
